...
<script type="text/javascript" src="<c:url value='/js/push/cam/campListP.js'/>"></script>
		...
		<div id="content">
			...
			<section class="cont-body">
				...
				<form id="searchForm" name="searchForm" method="post">
					...
					<input type="hidden" id="campNo" name="campNo" value="${searchVO.campNo}">
					...
					<fieldset>
							...
							<div class="list-area">
								<ul>
									...
									<li>
										<label>캠페인명</label>
										<div class="list-item">
											<input type="text" id="searchCampNm" name="searchCampNm" placeholder="캠페인명을 입력해주세요.">
										</div>
									</li>
									<li>
										<label>캠페인목적</label>
						...
						<!-- 목록&페이징// -->
						<div id="divCampList" style="margin-top:50px;"></div>
						<!-- //목록&페이징 -->
