	...
	<form id="popCampSearchForm" name="popCampSearchForm" method="post">
		...
		<fieldset>
			...
			<div class="btn-wrap mgt10 tar">
				<button type="button" class="btn fullorange" onclick="goPopCampSearch('1');">검색</button>
			</div>
			<!-- //btn-wrap -->
			...
			<div class="graybox">
				<div class="title-area">
					...
					<!-- 버튼// -->
					<div class="btn-wrap">
						<button type="button" class="btn fullorange plus" onclick="goPopCampAdd();">신규등록</button>
					</div>
					<!-- //버튼 -->
				</div>
