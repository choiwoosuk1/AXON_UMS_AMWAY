        ...
        <div class="grid-area">
            <table class="grid">
                ...
                <c:if test="${fn:length(pushSendList) > 0}">
                    <c:forEach items="${pushSendList}" var="smsSend" varStatus="status">
                        <tr>
                            <td><c:out value="${pageUtil.totalRow - (pageUtil.currPage-1)*pageUtil.pageRow - status.index}"/></td>
                            <td><a href="javascript:goPushList('<c:out value='${smsSend.campNo}'/>');" class="bold"><c:out value="${smsSend.campNm}"/></a></td>
                            <td>
                            ...
                            <td><c:out value='${smsSend.pushCount}'/></td>
                            <td><c:out value='${smsSend.pushName}'/></td>
