			...
			<section class="cont-body">
				<div class="user-wrap">
					<form id="userInfoForm" name="userInfoForm" method="post">
						...
						<input type="hidden" name="checkIdYn" id="checkIdYn" value="N">
						<fieldset>
							<legend>내용</legend>
									...
									<ul>
										<li>
											...
											<div class="list-item">
												...
												<button type="button" class="btn fullred" id="checkId" onclick="checkUserId()" value="N">검색</button>
											</div>
										</li>
										<li>
										...
										<li style="display: none;">
											...
											<div class="list-item">
												<input type="password" id="userPwd" name="userPwd" placeholder="영문,숫자, 특수문자 중 2가지 이상을 혼합하여 8자리 이상의 비밀번호를 입력해주세요." >
											</div>
										</li>
										<li style="display: none;">
											<label class="required">비밀번호확인</label>
											<div class="list-item">
												<input type="password" id="userPwdChk" placeholder="비밀번호를 다시 입력해주세요." >
											</div>
										</li>
										...
										<li>
											...
											<div class="list-item">
												<input type="text" id="mailFromNm" name="mailFromNm" placeholder="발송자명을 입력해주세요.">
											</div>
										</li>										
										<li>
										...
										<li>
											...
											<div class="list-item">
												...
												<input type="hidden" id="orgCd" name="orgCd" value="0">
