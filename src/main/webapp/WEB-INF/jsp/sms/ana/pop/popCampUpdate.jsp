...
<div class="cont">
	...
	<form id="popCampInfoForm" name="popCampInfoForm" method="post">
		...
		<fieldset>
				...
				<div class="list-area">
					<ul>
						<li class="col-full">
							...
							<div class="list-item">
								<input type="text" name="campNm" value="<c:out value='${smsInfo.campNm}'/>" placeholder="캠페인명을 입력해주세요.">
							</div>
						</li>
						<li class="col-full">
							<label>설명</label>
							<div class="list-item">
								<textarea name="campDesc" style="height:200px;" placeholder="캠페인 설명을 입력해주세요."><c:out value='${smsInfo.campDesc}'/></textarea>
							</div>
						</li>
					</ul>
					...
					<ul>
						<li>
							<label>등록자</label>
							<div class="list-item">
								<p class="inline-txt"><c:out value="${smsInfo.regNm}"/></p>
							</div>
						</li>
						<li>
							<label>수정자</label>
							<div class="list-item">
								<p class="inline-txt"><c:out value="${smsInfo.upNm}"/></p>
							</div>
						</li>
						<li>
							<label>등록일시</label>
							<fmt:parseDate var="regDt" value="${smsInfo.regDt}" pattern="yyyyMMddHHmmss"/>
						...
						<li>
							<label>수정일시</label>
							<fmt:parseDate var="upDt" value="${smsInfo.upDt}" pattern="yyyyMMddHHmmss"/>
			...
			<!-- btn-wrap// -->
			<div class="btn-wrap">
				<button type="button" class="btn big fullgreen" onclick="goPopCampInfoUpdate();">수정</button>
