...
<script type="text/javascript" src="<c:url value='/js/sms/ana/smsCampSendListP.js'/>"></script>
<body>
							...
							<div class="list-area">
								<ul>
									...
									<li>
										<label>메세지명 </label>
										<div class="list-item">
											<input type="text" id="searchTaskNm" name="searchTaskNm" value="<c:out value='${searchVO.searchTaskNm}'/>" placeholder="메세지명을 입력해주세요.">
										</div>
									</li>
									<li>
										<label>전송유형</label>
