	...
	<form id="popSegSearchForm" name="popSegSearchForm" method="post">
		...
		<fieldset>
			...
			<div class="btn-wrap mgt10 tar">
				<button type="button" class="btn fullgreen" onclick="goPopSegSearch('1');">검색</button>
			</div>
			<!-- //btn-wrap -->
			...
			<div class="graybox">
				<div class="title-area">
					...
					<div class="btn-wrap">
						...
						<button type="button" class="btn fullgreen plus" onclick="goPopSegAdd();">신규등록</button>
					</div>
					<!-- //버튼 -->
				</div>
