...
<div class="cont">
	...
	<form id="popSegInfoFormMail" name="popSegInfoFormMail" method="post">
		...
		<fieldset>
					...
					<ul>
						<li>
							...
							<div class="list-item">
								...
								<button type="button" class="btn fullgreen" onclick="fn.popupOpen('#popup_file_seg');">등록</button>
						...
						<li>
							...
							<div class="list-item">
								...
								<button type="button" class="btn fullgreen" onclick="fncSep('<c:out value='${NEO_USER_ID}'/>');">등록</button>
							</div>
						</li>
						<li>
			...
			<!-- btn-wrap// -->
			<div class="btn-wrap">
				<button type="button" class="btn big fullgreen" onclick="goPopSegInfoUpdateFile('<c:out value='${NEO_USER_ID}'/>');">수정</button>
