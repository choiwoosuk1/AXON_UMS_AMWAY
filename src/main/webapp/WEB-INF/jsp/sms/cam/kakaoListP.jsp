...
<script type="text/javascript" src="<c:url value='/js/sms/cam/kakaoListP.js'/>"></script>
										...
										<div class="list-item">
											<div class="select">
												<select id="searchSmsStatus" name="searchSmsStatus" title="문자상태 선택">
													<option value="">선택</option>
													<c:if test="${fn:length(kakaoStatusList) > 0}">
														<c:forEach items="${kakaoStatusList}" var="smsStatus">
