...
<script type="text/javascript" src="<c:url value='/js/ems/ana/monthListP.js'/>"></script>
											...
											<li><label>발송일자</label>
												<div class="list-item">
													...
													<div class="monthpicker">
														<label> <input type="text" id="searchYm" name="searchYm" class="input-date"  readonly />
														</label>
													</div>
												</div></li>
											<!-- 								<li>
