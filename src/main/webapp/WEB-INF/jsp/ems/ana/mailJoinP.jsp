...
function goExcelDown() {
	$("#searchForm").attr("target","iFrmExcel").attr("action","./mailJoinExcel.ums").submit();
}
			...
			<section class="cont-body">
				...
				<div>
					<form id="searchForm" name="searchForm" method="post">
						...
						<fieldset>
							<legend>단기메일목록, 발송결과 및 세부에러</legend>
						
							<!-- 목록// -->
							<div class="graybox">
								<div class="title-area">
									<h3 class="h3-title">단기메일 목록</h3>
								</div>
											...
											<c:if test="${fn:length(mailList) > 0}">
												<c:forEach items="${mailList}" var="mail">
													...
													<tr>
														...
														<td class="tal"><c:out value='${mail.taskNm}'/></td>
