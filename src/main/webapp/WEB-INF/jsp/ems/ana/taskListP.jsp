		...
		<div id="content">
			...
			<section class="cont-body">
				...
				<form id="searchForm" name="searchForm" method="post">
					...
					<input type="hidden" id="sendRepeats" name="sendRepeat" value="000">
					...
					<fieldset>
							...
							<div class="list-area">
								<ul>
									...
									<li>
										...
										<div class="list-item">
											<div class="select">
												<select id="searchSendRepeat" name="searchSendRepeat" title="옵션 선택">
													<option value="">선택</option>
													<option value="000">단기메일</option>
													<option value="001">정기메일</option>
												</select>
											</div>
										</div>
									</li>
						...
						<!-- 목록&페이징// -->
						<div id="divTaskList" style="margin-top:50px;"></div>
						<!-- //목록&페이징 -->
