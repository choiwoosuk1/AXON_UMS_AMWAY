...
<div class="graybox">
	<div class="title-area">
		...
		<span class="total">Total: <em><c:out value="${fn:length(weekList)}"/></em></span>
	</div>
...
<!-- btn-wrap// -->
<div class="btn-wrap">
	<button type="button" class="btn big fullblue" onclick="goExcelDown('Week');">엑셀 다운로드</button>
</div>
<!-- //btn-wrap -->
