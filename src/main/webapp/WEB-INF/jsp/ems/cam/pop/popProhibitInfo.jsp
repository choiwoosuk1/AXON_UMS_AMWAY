...
<div class="cont">
			...
			<table class="grid">
				...
				<tbody>
					<tr>
						...
						<td  id="popProhibitAttach"><c:out value="${attachDesc}"/></td>
						<th scope="col">이미지 포함</th>
						<td id="popProhibitImage"><c:out value="${imgDesc}"/></td>
					</tr>
					<!-- 
					<tr>
						<th scope="col">마케팅 동의유형</th>
						<td><c:out value="${mktDesc}"/></td>
					</tr>
					 -->
				</tbody>
			</table>
	...
	<!-- btn-wrap// -->
	<div class="btn-wrap">
		<button type="button" class="btn big" onclick="fn.popupClose('#popup_prohibit_info');">닫기</button>
	</div>
	<!-- //btn-wrap -->
</div>
