...
<span class="logo-ums"><a href="/service.ums"><img src="/img/common/logo_ums.png" alt="UMS"></a></span>
<h1>이메일 시스템</h1>
				...
				<c:if test="${lvl1.menulvlVal == 1 && lvl1.serviceGb == 10}">
					<li<c:if test="${lvl1.menuId eq NEO_P_MENU_ID}"> class="active"</c:if>>
						...
						<c:choose>
							...
							<c:when test="${'M1004000' eq lvl1.menuId}"><c:set var="pMenuClass" value="item04"/></c:when>
						</c:choose>
