	...
	<div class="inner medium">
		...
		<div class="popcont">
			<div class="cont">
				...
				<!-- 미리보기 영역// -->
				<div id="previewContent" class="previewbox">
					<iframe id="iFrmWebAgent" name="iFrmWebAgent" frameborder="0" src="about:blank" style="border:0;margin:0;padding:0;width:800px;height:500px;"></iframe>
				</div>
				<!-- //미리보기 영역 -->
