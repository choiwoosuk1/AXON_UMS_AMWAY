...
<!-- 팝업 : 발송현황 일간일정// -->
<div id="popup_push_day_calendar" class="poplayer popcalendar"><!-- id값 수정 가능 -->
	<div class="inner">
		<header>
					...
					<div class="swiper-container datebannerswiper">
						<div class="swiper-wrapper">
							<div class="swiper-slide">
								...
								<!-- date-list// -->
								<div class="date-list" id="popPushDayList">
									<div class="wait">
		...
		<button type="button" class="btn_popclose" onclick="fn.popupClose('#popup_push_day_calendar');"><span class="hidden">팝업닫기</span></button>
	</div>
