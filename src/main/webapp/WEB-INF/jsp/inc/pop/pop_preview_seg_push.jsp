							...
							<table>
								...
								<tbody>
									...
									<tr class="pdtb-small" id="popCreateTyFile">
										...
										<td><button type="button" class="btn fullorange" onclick="goSearchReason();">조회</button></td>
									</tr>
									<!-- //파일연동,직접SQL인 경우 노출 -->
									...
									<tr class="pdtb-small" id="popCreateTyTool">
										...
										<td>
											<button type="button" class="btn fullorange" onclick="goSearchReason();">조회</button>
										</td>
									</tr>
									<!-- //추출조건,리타게팅인 경우 노출 -->
