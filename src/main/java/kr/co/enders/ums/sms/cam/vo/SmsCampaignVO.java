...
public class SmsCampaignVO extends CommonVO {
	...
	//추가정보
	private int campSmsCnt;			// 캠페인문자발송건
	...
	public int getCampSmsCnt() {
		return campSmsCnt;
	}
	public void setCampSmsCnt(int campSmsCnt) {
		this.campSmsCnt = campSmsCnt;
	}
