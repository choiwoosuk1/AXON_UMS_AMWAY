...
public class PushCampaignVO extends CommonVO {
	...
	//추가정보
	private int campPushCnt;		// 캠페인발송메일수
	...
	public int getCampPushCnt() {
		return campPushCnt;
	}
	public void setCampPushCnt(int campPushCnt) {
		this.campPushCnt = campPushCnt;
	}
