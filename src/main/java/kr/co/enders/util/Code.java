...
public class Code {
	...
	======================================================= */
	/** 숫자 */
	public static final int RAND_TYPE_A = 1;
	/** 숫자 + 문자 */
	...
	======================================================= */
	/** 길이 초과 */
	public static final int PWD_OVER = 1;
	/** 길이 부족 */
	public static final int PWD_LESS = 2;
	/** 조합 부족 */
	public static final int PWD_COMB = 3;
	/** 3자리 이상 같은 문자 또는 숫자가 포함 */
	public static final int PWD_CONT_EQUAL = 4;
	/** 연속된 3자리 이상의 문자나 숫자 */
	public static final int PWD_CONT_CHAR = 5;
	/** 연속된 3자리 이상의 키보드 문자 */
	public static final int PWD_CONT_KEY = 6;
	/** 알수 없는 오류 */
	public static final int PWD_EXCE = 9;
	/** 입력한 암호 없음 */
	public static final int PWD_NONE = 8;
	/** 암호 유효성 성공 */
